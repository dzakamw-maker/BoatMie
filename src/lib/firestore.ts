    ...
    if (!snapshot.empty) {
      return snapshot.docs.map((docSnap) => {
        ...
        return {
          ...
          imageUrl2: normalizeImageUrl(d.imageUrl2 || d.image_url2 || ''),
          imagePosX2: typeof d.imagePosX2 === 'number' ? d.imagePosX2 : (typeof d.image_pos_x2 === 'number' ? d.image_pos_x2 : 50),
          imagePosY2: typeof d.imagePosY2 === 'number' ? d.imagePosY2 : (typeof d.image_pos_y2 === 'number' ? d.image_pos_y2 : 50),
          imageScale2: typeof d.imageScale2 === 'number' ? d.imageScale2 : (typeof d.image_scale2 === 'number' ? d.image_scale2 : 100),
          content: d.content || '',
          details: d.details || [],
