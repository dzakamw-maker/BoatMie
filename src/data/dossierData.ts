import { FolderConfig, ProjectItem, CertificateItem, SkillCategory, InterestItem } from '../types/dossier';

export const FOLDERS_CONFIG: FolderConfig[] = [
  {
    id: 'about',
    label: 'About Me',
    category: 'Identity & Overview',
    categoryDesc: 'Personal dossier, core engineering philosophy, and background summary of Dzaka.',
    folderColor: '#2554d7',
    folderDarkColor: '#1d44b0',
    textColor: '#ffffff',
    badgeBg: '#1e40af',
    indexNumber: 'FILE-01',
  },
  {
    id: 'interests',
    label: 'Interests',
    category: 'Field Notes & Pursuits',
    categoryDesc: 'Late-night cafe hangouts, outdoor nature expeditions, Mobile Legends squad grinds, and swimming flow.',
    folderColor: '#dc2626',
    folderDarkColor: '#991b1b',
    textColor: '#ffffff',
    badgeBg: '#b91c1c',
    indexNumber: 'FILE-02',
  },
  {
    ...
    categoryDesc: 'Architecture capabilities across Modern Frontend, Scalable Backend, Cloud Infrastructure, and Applied AI.',
    folderColor: '#087f5b',
    folderDarkColor: '#056346',
    textColor: '#ffffff',
    badgeBg: '#047857',
    indexNumber: 'FILE-03',
  },
  {
    id: 'projects',
    label: 'Projects',
    category: 'Case Files & Works',
    categoryDesc: 'Curated production systems, full-stack applications, and experimental interactive web artifacts.',
    folderColor: '#6d28d9',
    folderDarkColor: '#4c1d95',
    textColor: '#ffffff',
    badgeBg: '#5b21b6',
    indexNumber: 'FILE-04',
  },
  {
    id: 'certificates',
    label: 'Certificates',
    category: 'Credentials & Badges',
    categoryDesc: 'Official recognitions, competitive olympiads (ISQO), AI mastery credentials, and technical accreditations.',
    folderColor: '#d97706',
    folderDarkColor: '#92400e',
    textColor: '#ffffff',
    badgeBg: '#b45309',
    indexNumber: 'FILE-05',
  },
  {
    ...
    categoryDesc: 'Encrypted communication channel, professional networks, and collaboration dispatch.',
    folderColor: '#1e293b',
    folderDarkColor: '#0f172a',
    textColor: '#ffffff',
    badgeBg: '#334155',
    indexNumber: 'FILE-06',
  },
